-- SpeakoAI Mock Data Population Script (Fixed)
...
-- Display summary (simplified to avoid errors)
SELECT 'Mock data population completed!' as status;

-- Show summary statistics (simplified)
...
-- Show sample questions (simplified)
SELECT 'Sample Questions:' as info;

SELECT 'Question ' || id || ': ' || LEFT(question_text, 50) || '...' FROM questions ORDER BY id; 